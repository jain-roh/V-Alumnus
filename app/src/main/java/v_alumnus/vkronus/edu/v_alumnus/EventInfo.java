...
public class EventInfo extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Vector");
        newsimg = (ImageView) findViewById(R.id.imgnevent);
        head = (TextView) findViewById(R.id.eventhead);
        det = (TextView) findViewById(R.id.eventsdet);
...
//http post
            try {
                ...
                //Why to use 10.0.2.2
                HttpPost httppost = new HttpPost("http://sagarsmailbox.esy.es/eventinfo.php?id="+id);
...
//convert response to string
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    img=json_data.getString("event_img");
                    desc= "\nDate & Time :"+json_data.getString("event_date")+"\t"+json_data.getString("event_time")+"\n\nLocation : "+json_data.getString("event_loc")+"\n\nDetails : "+json_data.getString("event_desc");
                    bitmap = BitmapFactory.decodeStream((InputStream) new URL("http://sagarsmailbox.esy.es/eventfiles/" + img).getContent());
                    id1=1;
